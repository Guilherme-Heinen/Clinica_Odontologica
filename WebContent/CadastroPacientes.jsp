        ...
        <div style="background-color: #C0D9D9">
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <h2 id="titulo" style="text-align: center; line-height: 60px; color: black;">Cadastro de Pacientes</h2>
                    </div>
                </div>
            </div>
        </div>
        <h3>Cadastro</h3>
        <form name="formulario_pacientes" action="InserirPaciente.jsp" method="get">
        <div class="form-row">
            	<div class="col-2">
                    <div class="form-group">
                        <label>ID</label>
            ...
            <div class="form-row">
            	<div class="col-2">
                    <div class="form-group">
                        ...
                        <input id="DATA_NASCIMENTO" type="text" name="DATA_NASCIMENTO" class="form-control" />
                    </div>
                </div>
                <div class="col-4">
                    <div class="form-group">
